...
def build_router(
    ...
    async def search_certificates(
        ...
        finding_code: str | None = Query(default=None),
        finding_code_contains: str | None = Query(default=None),
        has_wildcard: bool | None = Query(default=None),
        has_punycode: bool | None = Query(default=None),
        min_validity_days: int | None = Query(default=None, ge=0, le=5000),
        max_validity_days: int | None = Query(default=None, ge=0, le=5000),
